...
- 本ソフトウェアは現状のまま（"AS IS"）提供され、動作の保証はありません。
- 本ソフトウェアの使用または使用不能から生じたいかなる損害（データの損失・破損を含む）についても、作者は一切の責任を負いません。
- 変換・リサイズ処理は元ファイルを変更しない設計ですが、重要なファイルは事前にバックアップすることをおすすめします。
